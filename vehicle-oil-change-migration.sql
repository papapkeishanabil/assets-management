...
-- 4. Add index for odometer-based scheduling
...
-- 5. Add interval_type column to distinguish between TIME-based and ODOMETER-based scheduling
...
-- 6. Add next_odometer_threshold for BOTH mode
